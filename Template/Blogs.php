              ...
              <div class="owl-carousel owl-theme">
                  <div class="item">
                      <div class="card border-0 font-rale mr-5" style="width:18rem">
                          <h4 class = "card-title font-size-16" >Upcoming Mobiles</h4>
                            <img src="./assets/blog/blog1.jpg" alt="cart image" class="card-img-top">
                            <p class = "card-text font-size-14 text-black-50 py-1" >Lorem ipsum dolor sit amet consectetur, adipisicing elit. Veritatis voluptates iusto natus totam laudantium beatae ullam fuga odio? Ab, quia.</p>
